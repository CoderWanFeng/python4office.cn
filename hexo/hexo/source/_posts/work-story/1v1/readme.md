...
你好，我是程序员晚枫，本来是学法律的，毕业后自学转行成为程序员。



## 1、我能提供的价值

我根据自己的学习和转行经验，可以提供以下2个方面的经验分享：

1. **定制学习计划**：
   1. 1、针对想转行的朋友，根据你的自身情况（学历、城市、学习时间、期望薪资），制订一个转行程序员的专属学习计划。（不限于Python就业方向）
   2. 2、针对业余想学习Python的朋友，根据你的工作需求，帮你梳理一个有用的学习路线，没用的的不学，节约时间。
   3. 3、其中，需要用到的课程，我会在沟通后，帮你整理出来，沟通完你直接学习就行了。
2. **Python技术答疑**：
   1. 1、针对使用Python中遇到的问题，你自己百度后解决不了的，我可以给你远程解决。

## 2、我的联系方式



> 我不卖课，我卖经验：网上的免费资料太多了，但是你适合学哪个？第一步学什么、第二步学什么？我可以告诉你哪些资料有用，怎么学最快达到自己的目标。

这个经验是网上搜索不到的，也是我能提供的最大的价值。


> +微信之前先说明：非常欢迎您找我1对1语音咨询，但我是个普通打工仔，按次数收费：269元/次。

如果你需要，可以添加我的微信👉[点我查看微信二维码](https://www.python4office.cn/wechat-qrcode/)
...
- ⭐[VLOG合集 · 点我直达](https://www.python4office.cn/vlog-all/vlog-all/)
