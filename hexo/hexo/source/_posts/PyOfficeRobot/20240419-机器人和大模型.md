...
大家好，这里是程序员晚枫，正在all in [AI编程](https://www.python-office.com/course-002/AICoding/version-001/all.html)，去年十一没出去玩，在家里录制了一个课程：[给小白的《10讲 · Python微信机器人》（完结）](https://www.python-office.com/course-002/10-PyOfficeRobot/10-PyOfficeRobot.html)。
...
这里就是拿到大模型回复的地方，把这里替换为你自己的大模型接口，就可以直接在机器人使用了。如果这里有不明白的朋友，欢迎加入我的读者群和我交流👉[Python学习 · 读者交流群](https://mp.weixin.qq.com/s/h0MExYJag6hLnQg26yx98w)
