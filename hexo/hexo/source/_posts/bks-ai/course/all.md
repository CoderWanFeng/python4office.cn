...
**活动**：每周 1 场 AI直播，直播账号：[Python自动化办公社区](https://space.bilibili.com/259649365)
...
3.｜AI编程系列 
偏实用、能落地的技能：
①[AI编程：基础入门（人邮社）：系统打基础，适合零基础入门](https://www.bilibili.com/cheese/play/ss982042944?channel_id=1515397)
...
4.｜副业系列 
偏实战、可落地的赚钱思路：
①数字游民之自媒体：自媒体起号、运营、变现逻辑
②自由职业之第一个赚钱项目：从0到1做出自己的第一个可赚钱项目

5.｜AI系列 
主打AI工具实战变现：
①AI海报创作营：用AI快速做海报、封面、配图
②AI视频剪辑营：AI剪辑、文案、成片一条龙实操
③[AI大合集：各类AI工具、玩法、提示词整合，内容全面](https://mp.weixin.qq.com/s/KuyuljSXInUFavCz7iL5Yw)

6.Python 系列
- [15讲Python入门：系统打基础，适合零基础入门](https://mp.weixin.qq.com/s/Rn0_Tyu9uVP_NRO3LkhJoQ)
- [30讲数据分析：用Python进行数据采集、清洗、分析、可视化](https://mp.weixin.qq.com/s/p6MTu8512uzbM2_9vQFWPA)
- [50讲自动化办公：用Python自动化处理Excel、Word、PDF等文件](https://mp.weixin.qq.com/s/3eVM6XX8DHRVjp2PDWOhsA)
- 5讲OCR文字识别：用Python识别图片、证件、发票中的文字，并自动保存为Excel
- 10讲PDF处理：用Python自动化处理PDF文件，如合并、拆分、加密等
- 5讲邮件自动化：用Python自动化发送、接收、处理邮件
