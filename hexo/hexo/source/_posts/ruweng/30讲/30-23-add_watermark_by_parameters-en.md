---
title: 'Python Add Watermark to Images: Supports Text/Image Watermark, Adjustable Position/Transparency/Size, Essential for Protecting Your Images'
...
> **Add Watermark**: Only one line of code to add watermark to PDF files.
...
office.pdf.add_watermark_by_parameters(
    pdf_file=r"./test_files/30-23-add_watermark_by_parameters/test.pdf",
    mark_str="www.python-office.com",
    point=(10,10),
    output_file_name="./test_files/30-23-add_watermark_by_parameters/test1.pdf",
)
# Parameter explanation:
# pdf_file: Location of the PDF
# point: Watermark position
# mark_str: Watermark content to add
# output_file_name: Output file path + filename
```
