---
title: 'Python PDF to Word: 3 Lines of Code, Extract Tables and Images Automatically, Format Preserved'
...
> **PDF to Word Document**: Only one line of code needed. Enter the file location and it will convert automatically.
...
# output_path: Path + filename after conversion
# ps: Remember to specify the output filename
```
