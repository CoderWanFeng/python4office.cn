---
title: 'Python PDF Encryption: One-Click Set Password for PDF, Prevent Unauthorized Viewing, Supports Batch Encryption'
...
> **PDF Encryption**: Only one line of code, enter the file location to implement.
...
office.pdf.encrypt4pdf(
    input_file=r'F:\自动化办公\30chapter\test_files\30-24-encrypt4pdf\码农如瓮.pdf',
    password="123@#",
    output_file=r'F:\自动化办公\30chapter\test_files\30-24-encrypt4pdf\码农如瓮up.pdf'
)
# Parameter explanation:
# path: Path + filename of the PDF to encrypt
# password: Password
# output_path: Output PDF path + filename
```
