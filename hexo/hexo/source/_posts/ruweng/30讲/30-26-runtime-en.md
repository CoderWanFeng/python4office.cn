---
title: 'Python Code Timer: 1 Line of Code to Measure Function Runtime, Performance Analysis Tool'
...
> **Code Runtime**: Only one line of code, enter the file location to implement.
## 2. Usage Instructions
#### Download potime
Only one command is needed to automatically download and install potime
```
pip install potime
```
#### Call the Function
...
from potime import RunTime  # From potime, import the RunTime module
