---
title: "Python Count Code Lines: Count Entire Project's Code in 1 Second, Supports Multi-Language Auto-Classification"
...
> **Count Code Lines**: Only one line of code to count all code lines in a folder.
## 2. Usage Instructions
#### Download pocode
Only one command is needed to automatically download and install pocode
```
pip install pocode
```
#### Call the Function
...
count_of_code_lines, count_of_blank_lines, count_of_annotation_lines = pocode.line.count_line(code_path=r'F:\自动化办公\30chapter')
print(f'Total code lines: {count_of_code_lines}, Blank lines: {count_of_blank_lines}, Comment lines: {count_of_annotation_lines}')
# Parameter explanation:
# code_path: Path where code is located
# count_of_code_lines: Total lines of code
# count_of_blank_lines: Blank lines in code
# count_of_annotation_lines: Comment lines in code
...
CoderWanFeng focuses on AI programming training. Beginners can start making AI projects after watching his tutorial [《30 Lectures · AI Programming Training Camp》](https://mp.weixin.qq.com/s/VXmJjQwsQlY-2IHjA3OAYA) collaborated with Turing Community.
