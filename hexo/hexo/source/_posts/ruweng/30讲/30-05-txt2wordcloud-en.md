...
> **Text to Word Cloud Image**: Only one line of code to generate a corresponding word cloud image from text content.
...
office.image.txt2wordcloud(filename=r'./test_files/30-05-txt2wordcloud/python-office.txt',
                           color="black",
                           result_file="./test_files/30-05-txt2wordcloud/your_wordcloud.png")
# Parameter explanation:
# filename: Path to the text file
# color: Background color of the word cloud image
# result_file: Location + filename for the generated word cloud image
```
