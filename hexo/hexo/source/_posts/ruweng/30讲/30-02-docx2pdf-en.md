---
title: 'Python Word to PDF: 1 Line of Code, Supports Batch Conversion, Faster Than Manual Export'
...
> **Word to PDF**: Only one line of code needed. Enter the file location and it will convert automatically.
...
```
#### Call the Function
Copy the code below, modify the file location parameters according to the explanation, right-click and select Run
```python
...
# output_path: Output location after conversion, will be created automatically if it doesn't exist
```
