---
title: 'Python Auto Organize Files: One-Click Sort by Name/Date/Type, Say Goodbye to Manual File Organization'
...
> **Sort and Organize Files**: Only one line of code to organize files in a folder by file type.
...
office.file.group_by_name(path = r'./test_files/30-16-group_by_name')

# Parameter explanation:
# path: Folder path where files are located
```
