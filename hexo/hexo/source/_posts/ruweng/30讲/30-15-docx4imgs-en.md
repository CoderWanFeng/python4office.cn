---
title: 'Python Word to Images: One-Click Export All Pages as HD Images, Supports PNG/JPG Format'
...
> **PDF to Word Document**: Only one line of code to convert DOCX files to images.
...
# img_path: Storage location for extracted images. A subfolder will be automatically created in the specified folder, named after the Word document
```
