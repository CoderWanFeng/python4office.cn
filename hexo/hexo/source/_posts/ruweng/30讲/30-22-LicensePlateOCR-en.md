...
> **Recognize License Plate**: Only one line of code to recognize license plate information.
...
```python
import poocr # Import poocr

car_num = poocr.ocr.LicensePlateOCR(img_path=r'./test_files/30-22-LicensePlateOCR/程序员晚枫的车牌.png',
                                    id='AKIDmaBRaWFk4D9sWAd9lEYgdNuDQQbhZDqI',
                                    key='JOGuLacQ1OXTBfv53oMispcCH4e1B8rN')
print(car_num)
# Parameter explanation:
# img_path: Location + filename of the license plate image
# id: ID obtained from the link above
# key: Key obtained from the link above
```
