...
> **PDF to Word Document**: Only one line of code to download images using URL.
...
office.image.down4img(url='https://profile-avatar.csdnimg.cn/c7ea241d22e84bb1a9b8e929f8e35c6c_qq_41813454.jpg!1',
                      output_path=r'.\test_files\30-09-down4img')
# Parameter explanation:
# url: Link of the image to download
# output_path: Location to save downloaded images
```
