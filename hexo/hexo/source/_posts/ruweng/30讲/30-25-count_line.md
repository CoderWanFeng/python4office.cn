---
title: "Python统计代码行数：1秒统计整个项目的代码量，支持多语言自动分类" 
...
## 1. 功能介绍
今天我们介绍这个库的功能之一：
> **统计代码数量**: 只需要一行代码，统计文件夹下所有代码数量。
## 2. 使用说明
#### 下载pocode
只需要下面这一条命令，就可以自动下载和安装pocode
```
pip install pocode
```
#### 调用功能
...
# 参数解释：
# code_path：代码存放的路径
# count_of_code_lines：代码总行数
# count_of_blank_lines：代码空行
# count_of_annotation_lines：代码注释
