---
title: 'Python Video to Audio: One-Click Extract Audio from Video, Supports MP3/WAV Format, Batch Extraction'
...
> **Video to Audio**: Only one line of code to convert video files to audio files.
...
# path: Location + filename of the mp4 file
# mp3_name: Output path for the converted mp3 file
```
