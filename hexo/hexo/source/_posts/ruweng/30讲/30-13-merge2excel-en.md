...
> **Merge Excel**: Only one line of code to merge all Excel files in a folder into one.
...
office.excel.merge2excel(dir_path=r'./test_files/30-13-merge2excel',
                         output_file=r'./test_files/30-13-merge2excel/out/程序员晚枫-全平台统计.xlsx')
# Parameter explanation:
# dir_path: Path where Excel files to merge are located
# output_file: Output path + filename
