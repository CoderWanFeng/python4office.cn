---
title: 'Python Compress Folder: One-Click Batch Compress, Supports ZIP/RAR Format, Auto-Exclude Redundant Files'
...
> **Compress Folder to ZIP**: Only one line of code to compress folders in a directory into ZIP files.
## 2. Usage Instructions
#### Download pofile
Only one command is needed to automatically download and install pofile
```
pip install pofile
```
#### Call the Function
...
pofile.zip4dir(path=r'.\test_files\30-18-zip4dir')
# Parameter explanation:
# path: Path where folders to compress are located
```
