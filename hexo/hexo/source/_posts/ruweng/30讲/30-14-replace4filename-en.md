---
title: 'Python Batch Rename: Supports Regex Replacement, Sequential Numbers, Date Format, Essential for File Management'
...
> **Replace Filename**: Only one line of code, enter the file location to implement.
...
office.file.replace4filename(path=r'./test_files/30-14-replace4filename',
                             del_content='小红书-程序员晚枫',
                             replace_content='抖音-程序员晚枫',
                        )
# Parameter explanation:
# path: Root directory of folders/files to rename, note: the root directory name will not be changed
# del_content: Filename to replace/delete
# replace_content: Filename to replace with
```
