---
title: "Python批量重命名：支持正则替换、序号递增、日期格式，文件管理必备" 
...
# 参数解释：
# path：需要修改文件夹/文件名称的根目录，注意：该根目录名称不会被修改
# del_content：需要替换/删除的文件名
# replace_content：想被替换成的文件名
```
