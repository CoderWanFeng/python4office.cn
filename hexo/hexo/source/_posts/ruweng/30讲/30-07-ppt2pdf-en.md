...
> **PDF to Word Document**: Only one line of code to convert PPT to PDF file.
...
office.ppt.ppt2pdf(path=r'./test_files/30-07-ppt2pdf/input/程序员晚枫.pptx',output_path=r'./test_files/30-07-ppt2pdf/output')

# Parameter explanation:
# path: Path + filename of the file to convert
# output_path: Output path for converted file
```
