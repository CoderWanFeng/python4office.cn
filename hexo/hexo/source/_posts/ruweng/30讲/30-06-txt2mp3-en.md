---
title: 'Python Text to Speech: Supports Chinese Reading, Multiple Voices, Speed Adjustment, Make Your Own Audiobook'
...
> **Text to MP3 File**: Only one line of code to convert text content to MP3 audio.
...
# file: Specified file to read, highest priority
# mp3: Location and filename to save the MP3
# peak: True, read immediately; False, don't read
```
