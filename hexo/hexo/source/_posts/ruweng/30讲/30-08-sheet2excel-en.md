---
title: 'Python Excel Split Sheet: One-Click Split 1 Sheet into 100 Files, Auto-Named'
...
> **Sheet to Individual Excel**: Only one line of code to split all sheets in one Excel into separate Excel files with the same name.
...
office.excel.sheet2excel(file_path=r'test_files/30-08-sheet2excel/程序员晚枫的表格.xlsx',
                         output_path=r'test_files/30-08-sheet2excel')
# Parameter explanation:
# file_path: Path + filename of the file to convert
# output_path: Output path for converted files
```
