---
title: 'Python Add Flag to Avatar: One-Click Generate World Cup/Olympic Style Avatar, Supports Multiple Country Flags Auto-Overlay'
...
> **Add Flag to Avatar**: Only one line of code to add a national flag to your avatar.
## 2. Usage Instructions
#### Download poimage
Only one command is needed to automatically download and install poimage
```
pip install poimage
```
#### Call the Function
...
```python
import poimage # Import python-office
...
# profile_path: Location + filename of the image to convert
# output_path: Location + filename for the image with flag added
```
