---
title: 'Python Excel to PDF: Batch Export HD PDF, Table Format Stays Intact, Supports Automatic Pagination'
...
> **Excel to PDF**: Only one line of code to convert Excel to PDF.
...
office.excel.excel2pdf(excel_path=r'./test_files/30-19-excel2pdf/程序员晚枫的账号和粉丝.xlsx', pdf_path=r'./test_files/30-19-excel2pdf/output')

# Parameter explanation:
# excel_path: Path + filename of the file to convert
# pdf_path: Output path for converted file
```
