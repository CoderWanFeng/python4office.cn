---
title: 定时群发早报资讯？Python微信机器人帮你搞定
...
![定时群发早报资讯？Python微信机器人帮你搞定](https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=800&h=400&fit=crop)



大家好，我是晚枫，用通俗易懂的方式，教小白学python。

今天，我们开始学习《11讲Python微信机器人》课程的第6讲。

这一讲是介绍如何用Python一行代码实现微信机器人定时群发的功能。

比如，有的小伙伴可能想要在群里每天早上定时发送个早报资讯一类的信息，那么就会用到这个定时群发的功能。

基于此场景需求，我们团队就开发了用一行Python代码就能实现微信机器人定时群发的功能。
...
虽然，我们这个功能的需求很好理解，就是实现微信机器人定时群发的功能，但是关键是我们如何用Python代码来实现。
...
PyOfficeRobot.chat.send_message_by_time(who='程序员晚枫', message='你好', time='21:51:55')
```
参数解释：
```
who:消息发给谁, 
...
OK，到这里我要告诉大家的是，今天这篇文章教给大家的代码的视频讲解都在《11讲Python微信机器人》这套课程的第6讲内容中了，对讲解视频感兴趣的可以去本套课程中学习一下。
