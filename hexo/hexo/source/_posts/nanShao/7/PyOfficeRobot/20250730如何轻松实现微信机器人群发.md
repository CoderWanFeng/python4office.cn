...
![如何轻松实现微信机器人群发](https://images.unsplash.com/photo-1517077304055-8e7232e8e848?w=800&h=400&fit=crop)



大家好，我是晚枫，用通俗易懂的方式，教小白学python。

今天，我们开始学习《11讲Python微信机器人》课程的第9讲。

这一讲是介绍我们这个微信机器人的桌面版群发的功能，所谓桌面版就是可以用鼠标操作的一个简易版的软件。

比如，有的小伙伴可能不懂代码，或者也不想去写代码，但是他又想用我们这个微信机器人，那这时候桌面版群发的机器人就派上用场了。

基于此场景需求，我们团队就开发了用一行Python代码就能实现微信机器人群发消息，且能用鼠标操作软件完成需求的功能。
...
虽然，我们这个功能的需求很好理解，就是实现微信机器人桌面版群发消息的功能，但是关键是我们如何用Python代码来实现。
...
第二，点击加载按钮，选择群发对象的那个Excel文件，加载完之后会继续弹出窗口，这个时候继续选择加载要群发的内容的文本文件。

第三，加载完毕之后，到右下角找到窗口，然后点击群发就能实现自动群发消息的功能了。

好的，通过代码演示和操作流程讲解，我相信你一定已经学会了该如何使用我们这个脚本。
...
OK，到这里我要告诉大家的是，今天这篇文章教给大家的代码的视频讲解都在《11讲Python微信机器人》这套课程的第9讲内容中了，对讲解视频感兴趣的可以去本套课程中学习一下。
...
![ 11讲Python微信机器人跳转到付费文章二维码-0.jpg](https://raw.atomgit.com/user-images/assets/5027920/1c93a0de-5eae-482f-b62e-6875eb845ff7/_11讲Python微信机器人跳转到付费文章二维码-0.jpg)
