---
title: 写完项目到底写了多少行？1 行 Python 直接告诉你答案
...
![20250729写完项目到底写了多少行1行Python直接告诉你答案.md](https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=800&h=400&fit=crop)



大家好，我是晚枫，用通俗易懂的方式，教小白学python。

今天，我们一起来聊一聊如何用Python技术的手段，一行代码实现统计代码的行数。

我相信很多小伙伴有这样的需求哈，虽然我们都知道代码编辑器软件都有行数显示，但是如果我们想实现统计一个项目完成之后写了多少行代码，这个时候该如何做呢？

不知道了吧，其实我们今天要讲的这个代码就是为解决这个问题而开发的，而且我们仅仅用了一行代码就实现了功能。
...
虽然，我们这个功能的需求很好理解，就是实现统计代码行数，但是关键是我们如何用Python代码来实现。
...
OK，到这里我要告诉大家的是，今天这篇文章教给大家的代码的视频讲解都在给小白的《50讲Python自动化办公》这套课程的第44讲内容中了，对讲解视频感兴趣的可以去本套课程中学习一下。
