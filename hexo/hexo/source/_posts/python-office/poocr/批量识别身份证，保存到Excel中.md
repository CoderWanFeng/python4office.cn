...
![入门案例！批量识别身份证自动保存为Excel文件，1行Python代码实现 - 配图1](https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=800)
![入门案例！批量识别身份证自动保存为Excel文件，1行Python代码实现 - 配图2](https://images.unsplash.com/photo-152637909?w=800&h=400&fit=crop)
