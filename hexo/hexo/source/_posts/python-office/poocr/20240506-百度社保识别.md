...
大家好，这里是程序员晚枫，正在all in [AI编程](https://www.python-office.com/course-002/AICoding/version-001/all.html)，上个月在小破站给大家更新完了一套课程：[给小白的OCR批量识别保存为Excel（Python版）](https://mp.weixin.qq.com/s/xEX6tFUxPMZKdJIq5P7UOA)。
