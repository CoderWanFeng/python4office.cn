...
大家好，这里是程序员晚枫，正在all in [AI编程实战](https://mp.weixin.qq.com/s/TPjhtvaoWaJ7mVuPBymLhQ)，全网同名。本周，我们poocr团队又带来了一个超实用的功能升级：**支持多页PDF的发票识别**！这意味着你可以用一行代码轻松识别整本发票PDF，效率直接拉满！🚀
