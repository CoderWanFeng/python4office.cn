...
translation:
  source: work-story/fired-30-alal.md
  source_title: "迷茫！我30岁被裁员了，程序员高薪就是一个笑话"
  status: completed
...
1. **Specialists earn more than generalists.** A senior Go developer earns more than a "full-stack" developer who does Java, Python, and JavaScript at a mediocre level.
2. **Backend > Frontend for job security.** Backend roles are harder to outsource and easier to make AI-augmented.
3. **Domain expertise compounds.** A programmer who understands finance, healthcare, or logistics earns 2-3× a programmer who only knows code.
4. **AI skills are the new senior signal.** In 2026, a developer who can use Claude Code or Cursor is worth 3-5× one who can't.
...
He took 2 months to:
1. Take stock of his actual skills (Java backend + a bit of Python + a bit of business analysis)
2. Pick a vertical: he chose supply chain finance (金融+供应链)
3. Learn the domain deeply enough to be able to talk to customers, not just code
4. Use AI tools (Claude, Cursor) to 10× his output
