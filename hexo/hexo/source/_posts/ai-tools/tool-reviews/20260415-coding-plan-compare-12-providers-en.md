...
<a href="https://mp.weixin.qq.com/s/8p2eviFUmYa1V0pswmDRmw">
  ...
  <img src="https://img.shields.io/badge/Join-AI Exchange Group-brightgreen" alt="AI交流群">
</a>
...
**Coding Plan is each provider's "free trial package" for developers.**

Each provider has one, some give API quota, some give computing power, some give both.
...
In plain language: **"New User Gift Package" from each cloud provider for developers**.
...
**Purpose**: Let you try at low cost, pay after you like it.
...
|:---:|--------|----------|:----------:|
| 1 | **Alibaba Cloud** | Bailian / AI Model Studio | ⭐⭐⭐⭐ |
| 2 | **JD Cloud** | JD Cloud | ⭐⭐⭐ |
---
