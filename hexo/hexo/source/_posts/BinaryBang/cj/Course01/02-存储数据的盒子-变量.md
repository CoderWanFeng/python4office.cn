...
![第一行仓颉代码|存储数据的盒子:变量 - 配图1](https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=800)
![第一行仓颉代码|存储数据的盒子:变量 - 配图2](https://images.unsplash.com/photo-151707730?w=800&h=400&fit=crop)
