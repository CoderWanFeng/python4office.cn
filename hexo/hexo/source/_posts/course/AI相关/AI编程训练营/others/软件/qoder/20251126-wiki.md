...
> [AI编程课](https://mp.weixin.qq.com/s/uxCILtn9cfIsJR8PqOxlGQ)的群里，大家反映的``pandas、scrapy、requests、opencv``等项目，都可以按相同的方法学习。
...
解压后，用Qoder打开。此处不作解释，不会的朋友，看我上次直播，或者直接在[AI编程课程](https://mp.weixin.qq.com/s/uxCILtn9cfIsJR8PqOxlGQ)群里问我。
