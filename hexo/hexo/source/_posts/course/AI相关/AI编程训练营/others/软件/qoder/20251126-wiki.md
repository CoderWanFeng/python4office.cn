...
> 在这里先预告一下，12月的第2周，我会在重庆阿里中心有一场关于**Qoder使用经验**的分享，重庆的朋友欢迎来交流哟~我的微信：wfdev7。下面开始我们的正文。


曾经作为一个法学院转行的程序员，我面对看不懂的项目，**无数次的期盼有人能给我写一份项目说明书**：告诉我哪些项目里哪些目录中是重点代码？这些重点代码应该怎么用？
