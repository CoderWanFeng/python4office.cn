...
- 打开 VSCode，没有vscode的朋友请加我微信：wfdev7，加入我的[AI编程训练营](https://mp.weixin.qq.com/s/7rH5U6s91hnTKCKZy4BHCg)，我都会提供：下载和安装教程。
...
- Model ID：填入MiniMaxAI/MiniMax-M2。这里有疑问的，可以看我们[AI编程训练营](https://mp.weixin.qq.com/s/7rH5U6s91hnTKCKZy4BHCg)的视频。
