---
title: 一个下载量34.7万的开源项目，正在被AI编程重写
...
5年前，我创建了python-office这个项目。它的初衷很简单：**用一行代码，解决一个办公自动化问题。**
...
正是因为这种“傻瓜式”的设计，python-office在5年里收获了：
- 📥 **34.7万次下载**
- ⭐ **GitHub上60k+星标**
- 👥 **数万开发者的使用**
