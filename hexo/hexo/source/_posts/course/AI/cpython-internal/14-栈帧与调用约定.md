...
![第 14 讲：栈帧与调用约定——函数调用的底层过程 - 配图1](https://images.unsplash.com/photo-151707730?w=800&h=400&fit=crop)
![第 14 讲：栈帧与调用约定——函数调用的底层过程 - 配图2](https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=800)
