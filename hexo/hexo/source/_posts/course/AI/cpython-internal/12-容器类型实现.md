...
![第 12 讲：容器类型实现——list、dict、set 的 C 实现](https://images.unsplash.com/photo-1517077304055-8e7232e8e848?w=800&h=400&fit=crop)
![第 12 讲：容器类型实现——list、dict、set 的 C 实现](https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=800)
