...
![第 12 讲：容器类型实现——list、dict、set 的 C 实现 - 配图1](https://images.unsplash.com/photo-151707730?w=800&h=400&fit=crop)
![第 12 讲：容器类型实现——list、dict、set 的 C 实现 - 配图2](https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=800)
