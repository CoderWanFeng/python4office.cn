...
tags: [Python可调用对象, __call__, callable, Python函数, Python进阶, Python魔术方法, 流畅的Python]
...
![第 8 讲：Python 可调用对象 | __call__、函数对象、类作为函数与 callable 原理](https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=800&h=400&fit=crop)
