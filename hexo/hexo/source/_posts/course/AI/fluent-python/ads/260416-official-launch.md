...
不是书不好，是真的太干了。700多页，每章都是深度内容——第1章讲数据模型，第6章讲装饰器从闭包到描述符一气呵成，第17章讲并发模型让你理解GIL到底在什么情况下会释放。一个人闷头读，读着读着就卡住了。
...
每周直播带读 + 专属学习群 + 录播回放 + 配套练习。

直播不是念书，我会告诉你这章哪个知识点最关键，在实际项目中怎么用，以及面试会问到什么。读完有疑问，群里提问有问必答。直播时间不方便？以后随时看回放，有效期一年。读完不等于学会，每周还有配套练习帮你把知识内化。
...
写了1-3年Python，能写但说不清原理的；想跳槽Python高级岗位，不知道怎么准备的；买了《流畅的Python》但没读完，想找组织一起学的；或者就是想系统提升Python水平，从会用走到精通的。
...
我是程序员晚枫，做Python开发10年了，写过一个叫**python-office**的开源项目，GitHub上1.2k+ star，累计下载38w+。之前在大厂做过Python开发，也做过自动驾驶相关的项目。全网粉丝40w+，一直在分享Python技术，擅长把复杂的东西讲得通俗易懂。
