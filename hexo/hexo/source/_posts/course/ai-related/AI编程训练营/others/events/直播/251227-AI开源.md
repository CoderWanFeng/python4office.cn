---
title: 看不懂项目怎么办？用AI学习开源项目，哪里不会点哪里 | 大模型 | vibe coding | 小程序 | 个人网站 | Qoder
date: 2025-12-27 19:25:17
tags: AI编程
...
下方是**上次直播剪辑下来的视频**，大家可直接观看；这里给大伙儿做个简介介绍。
...
### ① 为什么一定要学**开源**  
- 即便不会编程，做项目时也**只是把业务项目拿回来改一改**  
- 大多数人**不是从头到尾写代码，而是改代码**  
- 这些「拿过来就能用」的项目，就是**开源项目**  
- 所以——**不管你用 AI 还是人工，都不可能绕过开源！**

### ② 直播讲什么？  
- **从哪里去找开源项目**  
- **完全不懂代码时，怎样通过 AI 把项目学明白**  
  - 最起码知道**改哪里适合自己**  
- **如何把项目开源出去，并用技术变现**  
  - 感兴趣的话，**一定要看这条视频**！

其他不多说，大家**直接去看视频**吧！看完欢迎交流～

## 直播视频

- [看不懂项目怎么办？用AI学习开源项目，哪里不会点哪里 | 大模型 | vibe coding | 小程序 | 个人网站 | Qoder](https://www.bilibili.com/video/BV19sviByEzu/?spm_id_from=333.1387.homepage.video_card.click&vd_source=ca20bb8763fcb18660aa74d7a87234fa)
