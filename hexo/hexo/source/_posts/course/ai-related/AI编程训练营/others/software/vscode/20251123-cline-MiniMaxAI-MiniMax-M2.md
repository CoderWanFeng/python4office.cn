...
- 打开 VSCode，没有vscode的朋友请加我微信：python-office，加入我的[AI编程训练营](https://mp.weixin.qq.com/s/YS0shsl6vJD_wUzow7NOnw)，我都会提供：下载和安装教程。
...
- Model ID：填入MiniMaxAI/MiniMax-M2。这里有疑问的，可以看我们[AI编程训练营](https://mp.weixin.qq.com/s/YS0shsl6vJD_wUzow7NOnw)的视频。
