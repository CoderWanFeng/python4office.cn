...
![阿里发布通义千问！1行代码，对话GPT大模型 - 配图1](https://images.unsplash.com/photo-161160569?w=800&h=400&fit=crop)

大家好，这里是程序员晚枫，正在all in [AI编程实战](https://mp.weixin.qq.com/s/8p2eviFUmYa1V0pswmDRmw)，今天给大家分享一个好用的东西👉1行代码，使用阿里的GPT聊天大模型：通义千问。
