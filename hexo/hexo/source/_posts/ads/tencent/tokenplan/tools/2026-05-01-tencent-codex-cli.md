...
Codex CLI 是 OpenAI 官方推出的命令行工具，接入腾讯云 Token Plan 可以获得更强的中文编程支持。

今天教大家怎么在 Codex CLI 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 Codex CLI 里用腾讯云 Token Plan？
...
### Step 2：在 Codex CLI 中配置腾讯云 Token Plan

Codex CLI 支持通过环境变量配置：

```bash
export OPENAI_API_KEY="你的SecretId:SecretKey"
export OPENAI_API_BASE="https://api.tokenplan.tencentcloudapi.com/v1"
```
