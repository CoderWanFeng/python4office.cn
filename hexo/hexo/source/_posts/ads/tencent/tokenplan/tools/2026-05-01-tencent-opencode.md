---
title: 在 OpenCode 里使用腾讯云 Token Plan
date: 2026-05-01 17:36:00
tags:
  - OpenCode
  - 腾讯云
  - Token Plan
...
OpenCode 是一个新兴的 AI 编程工具，接入腾讯云 Token Plan 可以获得更强的中文支持。

今天教大家怎么在 OpenCode 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 OpenCode 里用腾讯云 Token Plan？
...
### Step 2：在 OpenCode 中配置腾讯云 Token Plan
