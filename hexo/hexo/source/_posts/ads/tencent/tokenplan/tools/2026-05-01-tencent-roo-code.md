---
title: 在 Roo Code 里使用腾讯云 Token Plan
date: 2026-05-01 17:44:00
tags:
  - Roo Code
  - 腾讯云
  - Token Plan
...
Roo Code 是一个专注于代码审查和优化的 AI 工具，接入腾讯云 Token Plan 可以获得更强的中文支持。

今天教大家怎么在 Roo Code 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 Roo Code 里用腾讯云 Token Plan？
...
### Step 2：在 Roo Code 中配置腾讯云 Token Plan
