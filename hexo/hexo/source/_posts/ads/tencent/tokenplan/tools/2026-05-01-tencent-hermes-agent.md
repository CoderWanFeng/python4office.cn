...
Hermes Agent 是一个专注于自动化任务的 AI 助手，接入腾讯云 Token Plan 可以获得更强的中文支持。

今天教大家怎么在 Hermes Agent 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用腾讯云 Token Plan？
...
### Step 2：在 Hermes Agent 中配置腾讯云 Token Plan
