---
title: "在 Droid 里使用腾讯云 Token Plan"
...
Droid 是一个新兴的 AI 编程工具，接入腾讯云 Token Plan 可以获得更强的中文支持。

今天教大家怎么在 Droid 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 Droid 里用腾讯云 Token Plan？
...
### Step 2：在 Droid 中配置腾讯云 Token Plan
