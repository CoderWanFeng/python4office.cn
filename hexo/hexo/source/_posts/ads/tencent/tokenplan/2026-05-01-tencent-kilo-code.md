---
title: "在 Kilo Code 里使用腾讯云 Token Plan"
date: 2026-05-01 17:38:00
tags:
  - Kilo Code
  - 腾讯云
  - Token Plan
...
Kilo Code 是一个专注于轻量级代码生成的 AI 工具，接入腾讯云 Token Plan 可以获得更强的中文支持。

今天教大家怎么在 Kilo Code 里接入腾讯云混元大模型。

<!-- more -->

---

## 一、为什么要在 Kilo Code 里用腾讯云 Token Plan？
...
### Step 2：在 Kilo Code 中配置腾讯云 Token Plan
