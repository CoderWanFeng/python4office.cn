...
```
❯ Help me analyze the code structure of this project
❯ Where is the core functionality located?
❯ Help me modify this feature to support Chinese
❯ Run the tests
```

It will help you:
1. **Understand the code** — Tell you what each file does
2. **Find key code** — Precisely locate where you want to make changes
3. **Help you modify** — Make changes according to your needs, and tell you what was changed
4. **Automatic testing** — Automatically fix if it doesn't run
