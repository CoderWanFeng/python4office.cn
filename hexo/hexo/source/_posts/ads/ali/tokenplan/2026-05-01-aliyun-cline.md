---
title: "在 Cline 里使用阿里云百炼 Coding Plan"
...
Cline 是一个流行的 VS Code AI 编程插件，接入阿里云百炼可以获得更强的中文支持和更快的响应速度。

今天教大家怎么在 Cline 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 Cline 里用阿里云百炼？
