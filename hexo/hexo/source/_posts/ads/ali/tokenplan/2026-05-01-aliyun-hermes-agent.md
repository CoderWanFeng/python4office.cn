---
title: 在 Hermes Agent 里使用阿里云百炼 Coding Plan
...
Hermes Agent 是一个专注于自动化任务的 AI 助手，接入阿里云百炼可以获得更强的中文支持。

今天教大家怎么在 Hermes Agent 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用阿里云百炼？
...
### Step 2：在 Hermes Agent 中配置阿里云百炼
