---
title: 在 Codex CLI 里使用阿里云百炼 Coding Plan
...
Codex CLI 是 OpenAI 官方推出的命令行工具，接入阿里云百炼可以获得更强的中文编程支持。

今天教大家怎么在 Codex CLI 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 Codex CLI 里用阿里云百炼？
...
### Step 2：在 Codex CLI 中配置阿里云百炼

Codex CLI 支持通过环境变量配置：

```bash
export OPENAI_API_KEY="你的阿里云百炼API Key"
