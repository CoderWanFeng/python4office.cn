---
title: 在 OpenCode 里使用阿里云百炼 Coding Plan
...
OpenCode 是一个新兴的 AI 编程工具，接入阿里云百炼可以获得更强的中文支持和更快的响应速度。

今天教大家怎么在 OpenCode 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 OpenCode 里用阿里云百炼？
