---
title: 在 Kilo Code 里使用阿里云百炼 Coding Plan
...
Kilo Code 是一个专注于轻量级代码生成的 AI 工具，接入阿里云百炼可以获得更强的中文支持。

今天教大家怎么在 Kilo Code 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 Kilo Code 里用阿里云百炼？
