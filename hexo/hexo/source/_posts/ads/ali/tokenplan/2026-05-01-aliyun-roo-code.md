---
title: 在 Roo Code 里使用阿里云百炼 Coding Plan
...
Roo Code 是一个专注于代码审查和优化的 AI 工具，接入阿里云百炼可以获得更强的中文支持。

今天教大家怎么在 Roo Code 里接入阿里云百炼通义千问。

<!-- more -->

---

## 一、为什么要在 Roo Code 里用阿里云百炼？
