---
title: "在 Kilo Code 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:36:00
tags:
  - Kilo Code
  - Azure
  - OpenAI
...
Kilo Code 是一个轻量级的 AI 编程工具，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 Kilo Code 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 Kilo Code 里用 Azure OpenAI Coding Plan？

### Kilo Code 是什么？

Kilo Code 是一个轻量级的 AI 编程助手，专注于快速代码生成和优化。
...
### Step 2：在 Kilo Code 中配置 Azure OpenAI
...
配置成功后，在 Kilo Code 中直接使用 GPT-4 进行代码生成和优化。
