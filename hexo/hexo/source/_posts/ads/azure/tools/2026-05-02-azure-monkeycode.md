---
title: "在 MonkeyCode 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:44:00
tags:
  - MonkeyCode
  - Azure
  - OpenAI
...
MonkeyCode 是一个专注于轻量级代码生成的 AI 工具，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 MonkeyCode 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 MonkeyCode 里用 Azure OpenAI Coding Plan？
...
### Step 2：在 MonkeyCode 中配置 Azure OpenAI
...
配置成功后，在 MonkeyCode 中直接使用 GPT-4 进行代码生成和优化。
