---
title: "在 Zed 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:43:00
tags:
  - Zed
  - Azure
  - OpenAI
...
Zed 是一个高性能的代码编辑器，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 Zed 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 Zed 里用 Azure OpenAI Coding Plan？
...
配置成功后，在 Zed 中直接使用 GPT-4 进行代码生成和优化。
