---
title: "在 OpenClaw 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:31:00
tags:
  - OpenClaw
  - Azure
  - OpenAI
...
OpenClaw 是一个强大的 AI 编程助手，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 OpenClaw 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 OpenClaw 里用 Azure OpenAI Coding Plan？

### OpenClaw 是什么？

OpenClaw 是一个 AI 编程助手，支持代码生成、修改和项目理解，配置灵活。
...
### Step 2：在 OpenClaw 中配置 Azure OpenAI
...
配置成功后，在 OpenClaw 中直接使用 GPT-4 进行代码生成和优化。

---

## 三、GPT-4 在 OpenClaw 里能做什么？
...
### Q：Azure OpenAI 和直接用 OpenAI 有什么区别？

**A：**

Azure OpenAI 享受企业级安全保障，数据不会用于模型训练，合规性更强。
