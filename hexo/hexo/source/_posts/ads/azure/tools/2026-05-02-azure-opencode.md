---
title: "在 OpenCode 里使用 Azure OpenAI Coding Plan"
...
OpenCode 是一个开源的 AI 编程工具，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 OpenCode 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 OpenCode 里用 Azure OpenAI Coding Plan？

### OpenCode 是什么？

OpenCode 是一个开源的 AI 编程助手，支持代码生成、修改和项目理解。
...
### Step 2：在 OpenCode 中配置 Azure OpenAI
...
配置成功后，在 OpenCode 中直接使用 GPT-4 进行代码生成和优化。
