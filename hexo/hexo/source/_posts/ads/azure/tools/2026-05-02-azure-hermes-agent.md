---
title: "在 Hermes Agent 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:37:00
tags:
  - Hermes Agent
  - Azure
  - OpenAI
...
Hermes Agent 是一个智能体编程工具，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 Hermes Agent 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用 Azure OpenAI Coding Plan？

### Hermes Agent 是什么？

Hermes Agent 是一个基于 AI 的智能体编程工具，支持代码生成、修改和自动化任务。
...
### Step 2：在 Hermes Agent 中配置 Azure OpenAI
...
配置成功后，在 Hermes Agent 中直接使用 GPT-4 进行代码生成和优化。
