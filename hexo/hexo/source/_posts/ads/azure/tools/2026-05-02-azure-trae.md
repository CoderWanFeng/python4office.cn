...
TRAE 是字节跳动推出的 AI 代码编辑器，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 TRAE 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 TRAE 里用 Azure OpenAI Coding Plan？

### TRAE 是什么？

TRAE 是字节跳动推出的 AI 代码编辑器，支持代码生成、补全和审查。
...
### Step 2：在 TRAE 中配置 Azure OpenAI
...
配置成功后，在 TRAE 中直接使用 GPT-4 进行代码生成和优化。
