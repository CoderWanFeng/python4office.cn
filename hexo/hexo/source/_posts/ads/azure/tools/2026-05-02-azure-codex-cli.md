---
title: "在 Codex CLI 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:41:00
tags:
  - Codex CLI
  - Azure
  - OpenAI
...
Codex CLI 是 OpenAI 官方推出的命令行工具，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 Codex CLI 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 Codex CLI 里用 Azure OpenAI Coding Plan？

### Codex CLI 是什么？

Codex CLI 是 OpenAI 官方推出的命令行 AI 助手，支持代码生成和技术问答。
...
### Step 2：在 Codex CLI 中配置 Azure OpenAI

Codex CLI 支持通过环境变量配置：

```bash
export OPENAI_API_KEY="你的Azure OpenAI API Key"
export OPENAI_API_BASE="https://<你的资源名>.openai.azure.com/v1"
```
