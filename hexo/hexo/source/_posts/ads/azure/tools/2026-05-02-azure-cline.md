---
title: "在 Cline 里使用 Azure OpenAI Coding Plan"
date: 2026-05-02 22:38:00
tags:
  - Cline
  - Azure
  - OpenAI
...
Cline 是一个流行的 VS Code AI 编程插件，接入 Azure OpenAI 可以获得 GPT-4 的强大能力，同时享受 Azure 企业级安全保障。

今天教大家怎么在 Cline 里接入 Azure OpenAI 大模型。

<!-- more -->

---

## 一、为什么要在 Cline 里用 Azure OpenAI Coding Plan？
...
### Step 2：在 Cline 中配置 Azure OpenAI
...
配置成功后，在 VS Code 中使用 Cline，响应速度快。
