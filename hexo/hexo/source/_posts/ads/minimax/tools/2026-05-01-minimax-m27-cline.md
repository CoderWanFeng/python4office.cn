---
title: 在 Cline 里使用 MiniMax M2.7
date: 2026-05-01 17:16:00
tags:
  - Cline
  - MiniMax
  - M2.7
...
Cline 是一个轻量级但功能强大的AI编程插件，接入 MiniMax M2.7 可以获得更强的中文代码生成和视觉理解能力。

今天教大家怎么在 Cline 里配置 MiniMax。
