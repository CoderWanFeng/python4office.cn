---
title: 在 Hermes Agent 里使用 MiniMax M2.7
date: 2026-05-01 17:14:00
tags:
  - Hermes Agent
  - MiniMax
  - M2.7
...
Hermes Agent 是一个智能代理工具，接入 MiniMax M2.7 可以解锁更强的多模态分析和中文处理能力。

今天教大家怎么在 Hermes Agent 里配置 MiniMax。
