---
title: 在 OpenCode 里使用 MiniMax M2.7
date: 2026-05-01 17:10:00
tags:
  - OpenCode
  - MiniMax
  - M2.7
...
OpenCode 是一个轻量级的AI编程工具，接入 MiniMax M2.7 可以获得更强的中文编程支持。

今天教大家怎么在 OpenCode 里配置 MiniMax。
