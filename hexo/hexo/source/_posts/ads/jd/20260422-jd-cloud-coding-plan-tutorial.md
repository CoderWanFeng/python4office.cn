...
![京东云 JD Cloud Coding Plan 入门教程：从注册到用上 AI 编程（2026最新版） - 配图1](https://images.unsplash.com/photo-1677443994799-97b6aae1?w=800&h=400&fit=crop)
![京东云 JD Cloud Coding Plan 入门教程：从注册到用上 AI 编程（2026最新版） - 配图2](https://images.unsplash.com/photo-1518709268805-4e6709f4?w=800&h=400&fit=crop)
...
上期给大家介绍了京东云 JD Cloud Coding Plan，今天来一个**手把手入门教程**，从注册到配置，手把手教你用起来。

## 一、准备工作

### 需要准备的东西

1. 一个京东账号（没有的话去 jd.com 注册）
2. 实名认证（国内云服务都需要）
3. 一台电脑（Windows/Mac/Linux 都行）
4. 稳定的网络

### 推荐浏览器

Chrome、Edge、Firefox 都行，推荐 Chrome。
...
新用户通常有试用额度，具体以官方为准。订阅后额度会大幅增加。

### Q2：支持哪些模型？

京东云 Coding Plan 主打：
- 京东自研模型
- 主流开源模型（如 Qwen、DeepSeek 等）

具体模型列表可在控制台查看。

### Q3：国内访问速度如何？

京东云在国内有多处节点，访问速度快，延迟低。比海外厂商稳定很多。

## 五、进阶使用技巧

### 1. 快捷键设置

在 IDE 设置里找到 Coding Plan 相关设置，开启你喜欢的快捷键。

### 2. 上下文优化

给 AI 更多上下文（代码注释、项目结构），生成结果会更准确。

### 3. 多模型切换

如果结果不满意，可以切换到其他模型试试，找到最适合你的那个。
