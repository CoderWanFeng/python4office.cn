...
Cline 是一个流行的 VS Code AI 编程插件，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 Cline 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 Cline 里用 Kimi Coding Plan？
