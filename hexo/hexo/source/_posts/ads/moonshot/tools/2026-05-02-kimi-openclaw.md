...
OpenClaw 是一个强大的 AI 编程助手，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 OpenClaw 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 OpenClaw 里用 Kimi Coding Plan？
...
| 模型名称 | `moonshot-v1-128k` 或 `moonshot-v1-8k` |
...
配置成功后，在 OpenClaw 中直接使用 Kimi 进行代码生成和优化。

---

## 三、Kimi 在 OpenClaw 里能做什么？

### 💻 大项目分析

```
帮我分析这个项目的架构，给我一个整体报告
```

128K token 可以一次分析几十个文件，效果很好。
...
```
用Kimi帮我写一个Python快速排序算法
```

Kimi 代码生成能力强，中文注释也很准确。
...
### Q：moonshot-v1-8k 和 128k 怎么选？

**A：**

- `moonshot-v1-8k`：适合日常编程任务，响应更快
- `moonshot-v1-128k`：适合大项目分析，一次处理更多上下文
