---
title: "在 Hermes Agent 里使用 Kimi Coding Plan"
date: 2026-05-02 23:21:00
tags:
  - Hermes Agent
  - Kimi
  - Moonshot
...
Hermes Agent 是一个智能体编程工具，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 Hermes Agent 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用 Kimi Coding Plan？
...
### Step 2：在 Hermes Agent 中配置 Kimi
...
配置成功后，在 Hermes Agent 中直接使用 Kimi 进行代码生成和优化。
