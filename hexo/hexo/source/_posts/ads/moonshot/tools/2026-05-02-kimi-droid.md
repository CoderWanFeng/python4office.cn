---
title: "在 Droid 里使用 Kimi Coding Plan"
date: 2026-05-02 23:26:00
tags:
  - Droid
  - Kimi
  - Moonshot
...
Droid 是一个新兴的 AI 编程工具，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 Droid 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 Droid 里用 Kimi Coding Plan？
...
配置成功后，在 Droid 中直接使用 Kimi 进行代码生成和优化。
