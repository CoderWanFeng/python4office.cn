---
title: "在 MonkeyCode 里使用 Kimi Coding Plan"
date: 2026-05-02 23:28:00
tags:
  - MonkeyCode
  - Kimi
  - Moonshot
...
MonkeyCode 是一个专注于轻量级代码生成的 AI 工具，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 MonkeyCode 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 MonkeyCode 里用 Kimi Coding Plan？
...
配置成功后，在 MonkeyCode 中直接使用 Kimi 进行代码生成和优化。
