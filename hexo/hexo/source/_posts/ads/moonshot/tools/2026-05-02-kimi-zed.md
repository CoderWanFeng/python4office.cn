---
title: "在 Zed 里使用 Kimi Coding Plan"
date: 2026-05-02 23:27:00
tags:
  - Zed
  - Kimi
  - Moonshot
...
Zed 是一个高性能的代码编辑器，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 Zed 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 Zed 里用 Kimi Coding Plan？
...
配置成功后，在 Zed 中直接使用 Kimi 进行代码生成和优化。
