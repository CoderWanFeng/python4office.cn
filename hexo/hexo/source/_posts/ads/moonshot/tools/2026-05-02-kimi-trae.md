---
title: "在 TRAE 里使用 Kimi Coding Plan"
date: 2026-05-02 23:18:00
tags:
  - TRAE
  - Kimi
  - Moonshot
...
TRAE 是字节跳动推出的 AI 代码编辑器，接入 Kimi 可以获得超长上下文能力，128K token 处理大型项目无压力。

今天教大家怎么在 TRAE 里接入 Kimi 大模型。

<!-- more -->

---

## 一、为什么要在 TRAE 里用 Kimi Coding Plan？
...
配置成功后，在 TRAE 中直接使用 Kimi 进行代码生成和优化。
