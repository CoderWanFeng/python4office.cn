...
MonkeyCode 是一个专注于轻量级代码生成的 AI 工具，接入智谱 GLM 可以获得国产大模型的优质能力，中文理解出色。

今天教大家怎么在 MonkeyCode 里接入智谱 GLM 大模型。

<!-- more -->

---

## 一、为什么要在 MonkeyCode 里用智谱 GLM Coding Plan？
...
配置成功后，在 MonkeyCode 中直接使用 GLM 进行代码生成和优化。
