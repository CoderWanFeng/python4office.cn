---
title: "在 Hermes Agent 里使用智谱 GLM Coding Plan"
date: 2026-05-02 22:51:00
tags:
  - Hermes Agent
  - 智谱
  - GLM
...
Hermes Agent 是一个智能体编程工具，接入智谱 GLM 可以获得国产大模型的优质能力，中文理解出色。

今天教大家怎么在 Hermes Agent 里接入智谱 GLM 大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用智谱 GLM Coding Plan？
...
### Step 2：在 Hermes Agent 中配置智谱 GLM
...
配置成功后，在 Hermes Agent 中直接使用 GLM 进行代码生成和优化。
