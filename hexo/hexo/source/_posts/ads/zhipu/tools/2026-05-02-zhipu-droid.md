...
Droid 是一个新兴的 AI 编程工具，接入智谱 GLM 可以获得国产大模型的优质能力，中文理解出色。

今天教大家怎么在 Droid 里接入智谱 GLM 大模型。

<!-- more -->

---

## 一、为什么要在 Droid 里用智谱 GLM Coding Plan？
...
配置成功后，在 Droid 中直接使用 GLM 进行代码生成和优化。
