---
title: "在 OpenCode 里使用智谱 GLM Coding Plan"
date: 2026-05-02 22:49:00
tags:
  - OpenCode
  - 智谱
  - GLM
...
OpenCode 是一个开源的 AI 编程工具，接入智谱 GLM 可以获得国产大模型的优质能力，中文理解出色。

今天教大家怎么在 OpenCode 里接入智谱 GLM 大模型。

<!-- more -->

---

## 一、为什么要在 OpenCode 里用智谱 GLM Coding Plan？
...
配置成功后，在 OpenCode 中直接使用 GLM 进行代码生成和优化。
