---
title: "在 OpenClaw 里使用智谱 GLM Coding Plan"
date: 2026-05-02 22:45:00
tags:
  - OpenClaw
  - 智谱
  - GLM
...
OpenClaw 是一个强大的 AI 编程助手，接入智谱 GLM 可以获得国产大模型的优质能力，中文理解出色，响应速度快。

今天教大家怎么在 OpenClaw 里接入智谱 GLM 大模型。

<!-- more -->

---

## 一、为什么要在 OpenClaw 里用智谱 GLM Coding Plan？
...
配置成功后，在 OpenClaw 中直接使用 GLM 进行代码生成和优化。

---

## 三、GLM 在 OpenClaw 里能做什么？
...
### Q：智谱 GLM 和 GPT-4 怎么选？

**A：**

智谱 GLM 中文理解更好、价格更实惠；GPT-4 英文能力更强。如果主要是中文编程场景，GLM 性价比更高。
