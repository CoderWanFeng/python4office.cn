...
Huawei doesn't have Coding Plan, but Baidu does.
...
Baidu's code models trained on massive code data, code capability leads domestically.

### 2. Ernie Bot Support

Ernie Bot is Baidu's large model:

| Version | Features |
|---------|----------|
| Ernie Bot 4.0 | Strongest version, effect close to GPT-4 |
| Ernie Bot 3.5 | Free version |
| Ernie Bot Turbo | Fast speed |
