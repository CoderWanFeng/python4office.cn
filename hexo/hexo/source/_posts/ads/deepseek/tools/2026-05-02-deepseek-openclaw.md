---
title: "在 OpenClaw 里使用 DeepSeek Coding Plan"
...
OpenClaw 是一个强大的 AI 编程助手，接入 DeepSeek 可以获得更强的代码生成和推理能力。

今天教大家怎么在 OpenClaw 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 OpenClaw 里用 DeepSeek Coding Plan？
...
配置成功后，在 OpenClaw 中直接使用 DeepSeek 进行代码生成和优化。

---

## 三、DeepSeek 在 OpenClaw 里能做什么？
...
### Q：DeepSeek 和其他模型有什么区别？

**A：**

DeepSeek 在代码生成和数学推理方面表现突出，是国产大模型中的佼佼者。
