---
title: "在 Droid 里使用 DeepSeek Coding Plan"
...
Droid 是一个新兴的 AI 编程工具，接入 DeepSeek 可以获得更强的中文编程支持。

今天教大家怎么在 Droid 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Droid 里用 DeepSeek Coding Plan？
