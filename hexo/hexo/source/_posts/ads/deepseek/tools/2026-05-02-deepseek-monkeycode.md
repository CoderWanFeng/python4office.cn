---
title: "在 MonkeyCode 里使用 DeepSeek Coding Plan"
...
MonkeyCode 是一个专注于轻量级代码生成的 AI 工具，接入 DeepSeek 可以获得更强的中文编程支持。

今天教大家怎么在 MonkeyCode 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 MonkeyCode 里用 DeepSeek Coding Plan？
