---
title: "在 Roo Code 里使用 DeepSeek Coding Plan"
...
Roo Code 是一个专注于代码审查和优化的 AI 工具，接入 DeepSeek 可以获得更强的中文编程支持。

今天教大家怎么在 Roo Code 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Roo Code 里用 DeepSeek Coding Plan？
