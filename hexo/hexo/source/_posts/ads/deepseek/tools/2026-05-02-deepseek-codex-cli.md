---
title: "在 Codex CLI 里使用 DeepSeek Coding Plan"
...
Codex CLI 是 OpenAI 官方推出的命令行工具，接入 DeepSeek 可以获得更强的中文编程支持。

今天教大家怎么在 Codex CLI 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Codex CLI 里用 DeepSeek Coding Plan？
...
### Step 2：在 Codex CLI 中配置 DeepSeek
