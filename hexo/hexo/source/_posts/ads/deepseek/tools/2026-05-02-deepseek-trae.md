---
title: "在 TRAE 里使用 DeepSeek Coding Plan"
...
TRAE 是字节跳动推出的 AI 代码编辑器，接入 DeepSeek 可以获得更强的代码生成能力。

今天教大家怎么在 TRAE 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 TRAE 里用 DeepSeek Coding Plan？
...
配置成功后，在 TRAE 中直接使用 DeepSeek 进行代码生成和优化。
