...
Claude Code 是 Anthropic 推出的命令行编程工具，接入 DeepSeek 可以获得更强的代码生成能力。

今天教大家怎么在 Claude Code 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Claude Code 里用 DeepSeek Coding Plan？
...
### Step 2：在 Claude Code 中配置 DeepSeek
