---
title: "在 Hermes Agent 里使用 DeepSeek Coding Plan"
...
Hermes Agent 是一个智能体编程工具，接入 DeepSeek 可以获得更强的代码生成和推理能力。

今天教大家怎么在 Hermes Agent 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用 DeepSeek Coding Plan？
...
配置成功后，在 Hermes Agent 中直接使用 DeepSeek 进行代码生成和优化。
