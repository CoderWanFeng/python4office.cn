---
title: "在 Kilo Code 里使用 DeepSeek Coding Plan"
...
Kilo Code 是一个轻量级的 AI 编程工具，接入 DeepSeek 可以获得更强的代码生成能力。

今天教大家怎么在 Kilo Code 里接入 DeepSeek 大模型。

<!-- more -->

---

## 一、为什么要在 Kilo Code 里用 DeepSeek Coding Plan？
...
配置成功后，在 Kilo Code 中直接使用 DeepSeek 进行代码生成和优化。
