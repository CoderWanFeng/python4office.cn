...
![火山方舟Coding Plan常见问题FAQ：你关心的都在这里 - 配图1](https://images.pexels.com/photos/7237415/pexels-photo-7237415.jpeg?auto=compress&cs=tinysrgb&w=800)
![火山方舟Coding Plan常见问题FAQ：你关心的都在这里 - 配图2](https://images.unsplash.com/photo-161160569?w=800&h=400&fit=crop)
...
不包含：
- 部分高级模型可能需要额外付费（具体看官方说明）

### Q2: 邀请码有什么用？

使用邀请码 **GF2QJX3V** 订阅，可能有：
- 额外优惠
- 延长试用期
- 其他福利（以官方活动为准）
...
在火山引擎控制台 → 费用中心 → 订阅管理，可以取消自动续费。

## 使用相关问题

### Q5: 支持哪些IDE？

理论上支持所有支持OpenAI API格式的IDE：
- ✅ Cursor
- ✅ VS Code (Continue插件)
- ✅ JetBrains系列 (CodeGPT插件)
- ✅ Vim/Neovim
- ✅ 任何支持自定义API的工具
...
支持，在API请求中设置 `"stream": true`。

### Q13: 支持函数调用(Function Calling)吗？
...
目前主要是文本模型，多模态能力查看官方更新。

## 对比相关问题

### Q16: 和GitHub Copilot比怎么样？

| 维度 | Copilot | Coding Plan |
|------|---------|-------------|
| 价格 | $10/月 | 36元/月 |
| 模型 | 1个 | 5+个 |
| 中文 | 一般 | 好 |
...
### Q17: 和ChatGPT Plus比怎么样？

ChatGPT Plus主要是聊天工具，Coding Plan是编程专用。

如果你主要写代码，Coding Plan更合适。

### Q18: 可以替代程序员吗？

不能。AI是辅助工具，帮你提高效率，但不能替代你的思考和创造力。
