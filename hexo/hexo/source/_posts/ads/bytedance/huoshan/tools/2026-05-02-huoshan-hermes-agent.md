---
title: "在 Hermes Agent 里使用火山方舟 Coding Plan"
date: 2026-05-02 19:36:00
tags:
  - Hermes Agent
  - 火山方舟
  - ARK
...
Hermes Agent 是一个专注于自动化任务的 AI 助手，接入火山方舟可以获得更强的中文支持。

今天教大家怎么在 Hermes Agent 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 Hermes Agent 里用火山方舟 Coding Plan？

### Hermes Agent 是什么？

Hermes Agent 是一个专注于自动化任务和工作流的 AI 助手，可以帮你完成各种自动化任务。
...
配置成功后，在 Hermes Agent 中直接使用 AI 功能。
