---
title: "在 TRAE 里使用火山方舟 Coding Plan"
...
TRAE 是字节跳动推出的 AI 编程工具，和火山方舟同属字节，接入火山方舟可以获得更强的中文支持。

今天教大家怎么在 TRAE 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 TRAE 里用火山方舟 Coding Plan？

### TRAE 是什么？

TRAE 是字节跳动推出的 AI 编程助手，支持代码生成、修改和项目理解。
