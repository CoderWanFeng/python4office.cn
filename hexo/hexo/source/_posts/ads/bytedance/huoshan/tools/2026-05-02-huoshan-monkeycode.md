---
title: "在 MonkeyCode 里使用火山方舟 Coding Plan"
...
MonkeyCode 是一个专注于轻量级代码生成的 AI 工具，接入火山方舟可以获得更强的中文支持。

今天教大家怎么在 MonkeyCode 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 MonkeyCode 里用火山方舟 Coding Plan？
