---
title: "在 Droid 里使用火山方舟 Coding Plan"
...
Droid 是一个新兴的 AI 编程工具，接入火山方舟可以获得更强的中文支持。

今天教大家怎么在 Droid 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 Droid 里用火山方舟 Coding Plan？

### Droid 是什么？

Droid 是一个专注于轻量级代码生成的 AI 工具，帮助开发者快速完成编程任务。
