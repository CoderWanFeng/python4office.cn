...
Kilo Code 是一个专注于轻量级代码生成的 AI 工具，接入火山方舟可以获得更强的中文支持。

今天教大家怎么在 Kilo Code 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 Kilo Code 里用火山方舟 Coding Plan？

### Kilo Code 是什么？

Kilo Code 是一个轻量级的 AI 代码生成工具，专注于快速生成高质量代码。
