---
title: "在 Cline 里使用火山方舟 Coding Plan"
date: 2026-05-02 19:37:00
tags:
  - Cline
  - 火山方舟
  - ARK
...
Cline 是一个流行的 VS Code AI 编程插件，接入火山方舟可以获得更强的中文支持和更快的响应速度。

今天教大家怎么在 Cline 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 Cline 里用火山方舟 Coding Plan？
