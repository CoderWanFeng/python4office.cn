---
title: "在 Grok CLI 里使用火山方舟 Coding Plan"
date: 2026-05-02 19:39:00
tags:
  - Grok CLI
  - 火山方舟
  - ARK
...
Grok CLI 是 xAI 推出的命令行工具，接入火山方舟可以获得更强的中文编程支持。

今天教大家怎么在 Grok CLI 里接入豆包大模型。

<!-- more -->

---

## 一、为什么要在 Grok CLI 里用火山方舟 Coding Plan？
...
### Step 2：在 Grok CLI 中配置火山方舟

Grok CLI 支持通过环境变量配置：

```bash
export GROK_API_KEY="你的AppID:SecretKey"
export GROK_API_BASE="https://ark.cn-beijing.volces.com/api/v3"
```
...
{
  "provider": "volcengine",
  "api_key": "你的AppID:SecretKey",
  "base_url": "https://ark.cn-beijing.volces.com/api/v3",
  "model": "doubao-20250526"
}
```
