...
date: "2022-06-08T14:25:46+08:00"
tags:
---
...
Nuitk<br/>A：将脚本、模块、包编译成可执行文件或扩展模块。
...
pycass<br/>A：Cassandra 的 Python Thrift 驱动。
...
modobo<br/>A：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
