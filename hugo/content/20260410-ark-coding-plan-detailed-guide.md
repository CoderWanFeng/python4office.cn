...
date: "2026-04-10T02:46:00+08:00"
tags:
  - "火山方舟Coding Plan指南"
  - "豆包代码模型"
  - "Kimi编程"
...
今天这篇是火山方舟Coding Plan的**完全指南**，从支持的模型、接入的工具、套餐选择到使用技巧，一次性讲清楚。

---

## 一、什么是火山方舟Coding Plan？

火山引擎推出的AI编程订阅服务，核心卖点：

- **6款主流代码模型**随便用
- **Auto智能调度**，自动选最优模型
- **支持Claude Code、Cursor等**主流工具
- **首月8.91元起**，试错成本极低
