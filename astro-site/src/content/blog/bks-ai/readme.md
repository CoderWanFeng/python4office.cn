...
| 课程名称 | 讲数 | 状态 | 适合人群 | 链接 |
|---------|------|------|----------|------|
| 30讲·AI编程训练营 | 30讲 | ✅ 已完成 | 完全零基础 | [查看](https://mp.weixin.qq.com/s/8p2eviFUmYa1V0pswmDRmw) |
| AI提示词入门 | - | ⏳ 待开发 | 想学提示词 | - |
...
> 程序员晚枫专注 AI编程培训，小白看完他和图灵社区合作的教程 [《30 讲·AI编程训练营》](https://mp.weixin.qq.com/s/8p2eviFUmYa1V0pswmDRmw) 就能上手做 AI项目。
